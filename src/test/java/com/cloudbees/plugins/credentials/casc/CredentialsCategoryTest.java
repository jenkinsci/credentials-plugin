...
class CredentialsCategoryTest {
    ...
    @Test
    @ConfiguredWithCode("credentials-category.yaml")
    void export(JenkinsConfiguredWithCodeRule r) throws Exception {
    ...
    @Test
    @ConfiguredWithCode("credentials-category.yaml")
    void exportUsernamePasswordCredentialsImplConfiguration(JenkinsConfiguredWithCodeRule r) throws Exception {
    ...
    @Test
    @ConfiguredWithCode("credentials-category.yaml")
    void exportCertificateCredentialsImplConfiguration(JenkinsConfiguredWithCodeRule r) throws Exception {
