...
image::images/web-ui-elements.png[scaledwith="90%"]
...
image::images/context-links.png[scaledwith="90%"]
...
image::images/credentials-store-action.png[scaledwith="90%"]
...
.Adding a new credentials domain
image::images/adding-domain.png[scaledwith="90%"]
...
image::images/defining-specification.png[scaledwith="90%"]

The most basic domain specification is a hostname specification

.Configuring a hostname domain specification
image::images/hostname-specification.png[scaledwith="90%"]

When configuring credentials domains remember

[quote]
The credentials API will excluding credentials from domains that do *not* match.
